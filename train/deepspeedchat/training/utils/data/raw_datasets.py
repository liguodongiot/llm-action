...
class PromptRawDataset(object):
    ...
    def __init__(self, output_path, seed, local_rank, dataset_name):
        ...
        if not ("Dahoas/rm-static" == dataset_name or "Dahoas/full-hh-rlhf" == dataset_name or "Dahoas/synthetic-instruct-gptj-pairwise" == dataitingxie/rlhf-reward-datasets" == dataset_name):
...
class DahoasSyntheticinstructgptjpairwiseDataset(PromptRawDataset):
    ...
    def __init__(self, output_path, seed, local_rank, dataset_name):
        ...
        self.raw_datasets =  load_dataset("parquet", data_dir='/home/guodong.li/data/dahoas/synthetic-instruct-gptj-pairwise/data', data_files=d
