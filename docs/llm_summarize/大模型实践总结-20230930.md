...
除此之外，还有像摩尔线程、壁仞科技、燧原科技等发布的AI加速卡。随着美国对国内高端芯片的进一步封锁，希望国产芯片早日雄起。
...
今年陆陆续续也写了不少关于大模型的文章，为了方便查看，均梳理了并放置在Github上面: https://github.com/liguodongiot/llm-action。 具体目录如下所示，目前该项目已经超过1400星。

![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/4bceb9b6529644a3bd87d2b93f7ec720~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image#?w=847&h=665&s=99787&e=png&b=ffffff)
