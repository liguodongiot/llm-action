...
def train(args, model, device, train_loader, optimizer, epoch, use_fp8):
    ...
    for batch_idx, (data, target) in enumerate(train_loader):
        ...
        train_detail_time= end_time-start_time
        train_detail_time_list.append(train_detail_time)
        ...
        if batch_idx % args.log_interval == 0:
            ...
            if args.dry_run:
                break
    sum_train_time = sum(train_detail_time_list)
    sum_train_time_list.append(sum_train_time)
...
def test(model, device, test_loader, use_fp8):
    ...
    sum_test_time = sum(test_time_list)
    sum_test_time_list.append(sum_test_time)
...
def main():
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        scheduler.step()
        train_run_time = mid - start
        inference_run_time = end-mid
        train_time_list.append(train_run_time)
        inference_time_list.append(inference_run_time)

    print("train time list: ",train_time_list)
    print("inference time list: ", inference_time_list)
    print("train time: ", sum(train_time_list))
    print("inference time: ", sum(inference_time_list))

    print("sum_train_time_list: ", sum_train_time_list)
    print("sum_test_time_list: ", sum_test_time_list)
    print("sum_train_time_list: ", sum(sum_train_time_list))
    print("sum_test_time_list: ", sum(sum_test_time_list))
